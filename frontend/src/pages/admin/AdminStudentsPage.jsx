                                ...
                                <tbody className="divide-y divide-gray-50">
                                    {filteredStudents.map((student) => (
                                        <tr key={student.id} className="hover:bg-gray-50 transition-colors group">
                                            ...
                                            <td className="px-6 py-4">
                                                <span className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-bold uppercase tracking-wide ${student.is_active ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'
                                                    }`}>
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                <div className="flex justify-end gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`p-2 bg-white border border-gray-200 rounded-lg transition ${student.is_active
                        ...
                        <div className="p-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                ...
                                <div className="bg-gray-50 p-5 rounded-2xl border border-gray-100">
                                    ...
                                    <div className="space-y-3 text-sm">
                                        ...
                                        <InfoRow label="Bölüm" value={selectedStudent.department_name} />                            <InfoRow label="Sınıf" value={selectedStudent.grade || '-'} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3">
                                <button
                                    ...
                                    className={`flex-1 py-3.5 font-bold rounded-xl transition flex items-center justify-center gap-2 ${selectedStudent.is_active
