          ...
          <div className="px-4 md:px-6 lg:px-8 pb-4 md:pb-6 lg:pb-8">
            <div className="flex flex-col md:flex-row items-center md:items-end gap-4 md:gap-6 -mt-12 md:-mt-16">
              ...
              <div className="relative shrink-0">
                <div className="w-20 h-20 md:w-28 md:h-28 lg:w-32 lg:h-32 rounded-2xl md:rounded-3xl bg-yellow-400 flex items-center justify-center text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 shadow-xl border-4 border-white">
                  {getInitials()}
                </div>
