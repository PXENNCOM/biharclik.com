          ...
          <main className="text-sm leading-relaxed text-gray-600 space-y-8 antialiased text-left max-w-4xl">
            ...
            {activeTab === 'hakkimizda' && (
              <section className="space-y-6">
                <div>
                  ...
                  <p>
                    biharçlık, İstanbul’un dinamik enerjisini üniversite gençliğinin potansiyeliyle birleştiren yenilikçi bir teknoloji platformudur. Biz bir kargo ya da lojistik firması değiliz; şehir içi kısa mesafeli teslimat ihtiyaçları ile harçlığını kazanmak isteyen üniversite öğrencilerini güvenli bir dijital köprüde buluşturan aracı bir pazar yeriyiz.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    İstanbul gibi büyük bir metropolde, bireysel veya kurumsal göndericilerin "hızlı, ekonomik ve çevre dostu" teslimat beklentilerine pratik bir çözüm sunuyoruz. Bunu yaparken, geleceğimiz olan üniversite öğrencilerinin ders programlarını aksatmadan, kendi özgür zaman planlamalarıyla yaya kurye olarak ek gelir (harçlık) elde etmelerine imkan sağlıyoruz.
                  </p>
                </div>
                ...
                <p className="pt-4 border-t border-gray-50 font-medium text-gray-900 italic">
                  bi harçlık, dayanışmanın, teknolojinin ve gençliğin gücüyle büyüyen bir topluluk hareketidir!
                </p>
              </section>
            )}
              ...
              <section className="space-y-6">
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li><strong className="text-gray-900">Yasaklı Gönderiler:</strong> Yasalara aykırı materyaller, yanıcı, patlayıcı, parlayıcı maddeler, nakit para, kıymetli madenler, canlı hayvanlar ve taşınması lisansa tabi olan hiçbir madde platform aracılığıyla taşınamaz. Gönderici, paketin içeriğinin yasalara uygun olduğunu taahhüt eder. İçerik nedeniyle doğabilecek her türlü idari ve cezai sorumluluk Gönderici’ye aittir.</li>
                    <li><strong className="text-gray-900">Kontrol Yükümlülüğü:</strong> Gönderici, paketi kuryeye güvenli ve korunaklı bir şekilde teslim etmekle; Öğrenci Kurye ise teslim aldığı paketi makul bir özenle taşımakla yükümlüdür. Platform, tarafların bu yükümlülüklerini yerine getirip getirmediğini denetlemekle mükellef değildir.</li>
                  </ul>
                </div>

                <div>
                  <h3 className="font-bold text-gray-900 mb-2">4. İptal ve Ücret İade Şartları</h3>
                  <p className="mb-3">Platform üzerinden oluşturulan teslimat taleplerine ilişkin iptal og iade koşulları şu şekildedir:</p>
                  <ul className="space-y-3">
            ...
            {activeTab === 'gizlilik' && (
              <section className="space-y-6">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-2">1. Toplanan Veriler og Toplanma Yöntemleri</h3>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li><strong className="text-gray-900">• Konum Bilgisi:</strong> Teslimat sürecinin yönetilebilmesi, en yakın taleplerin eşleştirilebilmesi ve gönderinin takibi amacıyla Öğrenci Kurye’lerin anlık veya arka plan konum verileri (yalnızca aktif teslimat ve görev esnasında).</li>
                    <li><strong className="text-gray-900">• Finansal Bilgiler:</strong> Göndericilerin ödeme yapabilmesi için kullanılan kart bilgileri (Bu bilgiler doğrudan BDDK onaylı lisanslı ödeme kuruluşu altyapısında saklanır, bi harçlık sunucularında tutulmaz). Kuryelerin harçlık aktarımları için IBAN ve banka hesap bilgileri.</li>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1.5">
                    ...
                    <li>Platform içi güvenliği sağlamak ve sahte/kötü niyetli üyelikleri engellemek,</li>
                    <li>Ödemelerin güvenli bir şekilde tahsil edilmesini ve öğrenci harçlıklarının ilgili hesaplara aktarılmasını koordine etmek,</li>
                ...
                <div>
                  ...
                  <p className="mb-3"><strong className="text-gray-900">Hizmetin Doğası Gereği Paylaşım:</strong> Teslimatın gerçekleşebilmesi adına, Gönderici’nin ad-soyad, adres ve telefon bilgileri ilgili Öğrenci Kurye ile; kuryenin ad-soyad, profil fotoğrafı ve anlık konumu ise Gönderici ile yalnızca ilgili teslimat süresince paylaşılır.</p>
                  <p className="mb-3"><strong className="text-gray-900">Platform Dışı Kullanım Sorumsuzluğu:</strong> Taraflar (Gönderici og Öğrenci Kurye), teslimat vesilesiyle öğrendikleri kişisel verileri (isim, telefon, adres vb.) yalnızca teslimatın tamamlanması amacıyla kullanabilirler. Teslimat bittikten sonra bu verilerin taraflarca kaydedilmesi, arşivlenmesi, üçüncü şahıslara verilmesi veya taciz/reklam vb. amaçlarla kullanılması durumunda doğacak tüm hukuki ve cezai sorumluluk veriyi kötüye kullanan tarafa aittir; biharçlık bu durumlardan sorumlu tutulamaz.</p>
              ...
              <section className="space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p>Ünvan / Ticari İsim: biharçlık (Bundan sonra "Platform" olarak anılacaktır)<br />
                    Web Adresi: biharclik.com<br />
                    E-posta: info@biharclik.com<br />
                    Adres: İstanbul/Üsküdar, Türkiye</p>
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-2">4. Platformun Rolü og Sorumsuzluk Beyanı</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                  <div className="space-y-1">
                    ...
                    <p className="text-gray-600 hover:text-gray-900 transition-colors">
                      <a href="mailto:support@biharclik.com">info@biharclik.com</a>
                    </p>
                  </div>
                  ...
                  <div className="space-y-1 md:col-span-2">
                    ...
                    <p className="text-gray-600">İstanbul / Üsküdar, Türkiye</p>
                  </div>
                </div>
